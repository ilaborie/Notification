...
public class NotifierDialog {
	 ...
	 * @param typeImg the type img
	 * @return the shell
	 */
	public static Shell notify(String title, String message, Image typeImg) {
		_shell = new Shell(Display.getDefault(), SWT.NO_FOCUS | SWT.NO_TRIM);
